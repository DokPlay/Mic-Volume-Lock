...
- **Диагностика причин**, включая Discord, Zoom, Steam/игры, настройки Windows, NVIDIA Broadcast / RTX Voice и AMD Noise Suppression.
...
4. Проверить вкладку **Диагностика**, если громкость всё равно часто меняется.

## Диагностика: кто может менять громкость

Windows не всегда сообщает, какое именно приложение изменило уровень микрофона. Поэтому Mic Volume Lock показывает практичные подсказки по самым частым источникам проблемы:
...
Некоторые драйверы, vendor APO, аппаратный AGC и exclusive-mode аудиопути могут влиять на реальное усиление микрофона вне обычного системного ползунка. Mic Volume Lock работает на уровне endpoint volume и даёт диагностику для остальных случаев.
